...
def main():
    ...
    # prepare the model
    target_model = SupConResNet(name='c2dresnet50', head='mlp', feat_dim=128, n_classes=args.n_classes)
    ...
    # prepare data
    train_data = Lung3D_ccii_patient_supcon(train=True,n_classes=args.n_classes)
    val_data = Lung3D_ccii_patient_supcon(train=False,n_classes=args.n_classes)
